...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <ajaxToolkit:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0" Height="548px"  VerticalStripWidth="" style="margin-right: 3px">
            ...
            <asp:TemplateField HeaderText="Name" SortExpression="vendor_name">
                ...
                <InsertItemTemplate>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="" 
                        ControlToValidate="TextBox1" Text="* Required" Display="Static" EnableClientScript="true" ToolTip="* Required" SetFocusOnError="True"></asp:RequiredFieldValidator>
                </InsertItemTemplate>
                <ItemTemplate>
 ...
 <!---------------------->   
        ...
        <ContentTemplate>
            <asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="SqlDataSource2" DataTextField="vendor_name" DataValueField="vendor_id" OnSelectedIndexChanged="selectVendorForEdit" AutoPostBack="True" CssClass="DropDown" ></asp:DropDownList>
            ...
            <asp:DetailsView ID="DetailsView2" runat="server" AutoGenerateRows="False" DataSourceID="SqlDataSource3" AllowPaging="True" DefaultMode="Insert" CellPadding="1" CellSpacing="1" ForeColor="#333333" GridLines="None" OnItemInserted="DetailsView2_ItemInserted">
                ...
                <FieldHeaderStyle BackColor="#D0D0D0" Font-Bold="False" />
                <Fields>
                    <asp:TemplateField HeaderText="Mr/Ms/Mrs" SortExpression="vendor_contact_honorific">
                        <EditItemTemplate>
                        ...
                        ControlToValidate="TextBox1" Text="* Required" Display="Static" EnableClientScript="true" SetFocusOnError="True"></asp:RequiredFieldValidator>
                        </InsertItemTemplate>
                        <ItemTemplate>
